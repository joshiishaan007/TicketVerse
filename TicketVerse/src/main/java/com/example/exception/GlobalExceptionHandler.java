...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Object> handleShowtimeConflictException(
            ShowtimeConflictException ex, WebRequest request) {
    ...
    public ResponseEntity<Object> handleBookingCancellationException(
    ...
    @ExceptionHandler(ShowtimeExpiredException.class)
    public ResponseEntity<Object> handleShowtimeExpiredException(
            ShowtimeExpiredException ex, WebRequest request) {
